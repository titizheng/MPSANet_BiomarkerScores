...
class Annotation(object):
    ...
    def inside_polygons(self, coord, is_positive):
        ...
        确定给定的坐标是否在正负坐标内注释的多边形。
        确定中心样本点，是否在注释区域内，如果在注释区域内，lable=1，如果在注释区域外lable=0
...
class Formatter(object):
    ...
    """
    def camelyon16xml2json(inxml, outjson,type):
        """
        ...
        # annotations_tumor = \
        #     root.findall('./Annotations/Annotation[@Color="#aa0000"]') ##"#aa0000"
        #
        # annotations_0 = \
        #     root.findall('./Annotations/Annotation[@Color="#00aa00"]') ###00aa00"
        if type == 'pos':
            annotations_tumor = \
                root.findall('./Annotations/Annotation[@Color="#F4FA58"]')  ##"这个是肿瘤的区域
            annotations_0 = []
        else:
            annotations_tumor = []
            annotations_0 = \
                root.findall('./Annotations/Annotation[@Color="#F4FA58"]')  ##这个是阴性的区域

        annotations_positive = annotations_tumor
        annotations_negative = annotations_0
